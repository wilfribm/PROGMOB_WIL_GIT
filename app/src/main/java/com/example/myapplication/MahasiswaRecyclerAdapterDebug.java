...
public class MahasiswaRecyclerAdapterDebug extends RecyclerView.Adapter<MahasiswaRecyclerAdapterDebug.ViewHolder> {

    private Context context;
    private List<Mahasiswa> mahasiswaList;


    public MahasiswaRecyclerAdapterDebug(Context context) {
